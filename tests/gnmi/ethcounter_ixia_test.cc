...
//
// To run this test:
// /google/data/ro/teams/biglab/biglab sandman -p gpins -t ${TESTBED}.gcl
// --skip_confirmation --lock_priority 2 then from google3 directory run:
// platforms/networking/gpins/testing/integration/system:ethcounter_ixia_test
// (this file)
//
...
TEST_P(ExampleIxiaTestFixture, TestInFcsErrors) {
  ...
  // ixia_interface will look something like: "108.177.95.172/4/3" which is the
  // IP address for the IXIA ixia21.sql80.net.google.com which is hooked up to
  // Taygeta ju2u1m1.sqs02.net.google.com appended with the card and port

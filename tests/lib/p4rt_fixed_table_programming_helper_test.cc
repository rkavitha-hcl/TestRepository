...
TEST_P(L3RouteProgrammingTest, RouterInterfaceIdFailsWithInvalidMacAddress) {
  EXPECT_THAT(RouterInterfaceTableUpdate(sai::GetIrP4Info(GetParam()),
                                         p4::v1::Update::INSERT,
                                         /*router_interface_id=*/"rid-0",
                                         /*port=*/"1",
...
TEST_P(L3RouteProgrammingTest, L3AdmitTableWithoutInPort) {
  ASSERT_OK_AND_ASSIGN(
      p4::v1::Update pi_update,
      L3AdmitTableUpdate(sai::GetIrP4Info(GetParam()), p4::v1::Update::INSERT,
                         L3AdmitOptions{
                             .priority = 10,

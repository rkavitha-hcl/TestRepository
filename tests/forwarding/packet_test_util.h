...
#ifndef GOOGLE_TESTS_FORWARDING_PACKET_TEST_UTIL_H_
#define GOOGLE_TESTS_FORWARDING_PACKET_TEST_UTIL_H_
...
struct TestInputOutput {
  ...
  std::vector<gpins::Packet> output;
};
...
#endif  // GOOGLE_TESTS_FORWARDING_PACKET_UTIL_H_

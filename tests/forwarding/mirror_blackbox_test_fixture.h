...
#ifndef GOOGLE_TESTS_FORWARDING_MIRROR_BLACKBOX_TEST_FIXTURE_H_
#define GOOGLE_TESTS_FORWARDING_MIRROR_BLACKBOX_TEST_FIXTURE_H_
...
#endif  // GOOGLE_TESTS_FORWARDING_MIRROR_BLACKBOX_TEST_FIXTURE_H_

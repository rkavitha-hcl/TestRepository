...
absl::StatusOr<SaiFields> GetSaiFields(const SymbolicPerPacketState& state) {
  ...
  auto tunnel_ipv6 = SaiIpv6{
      .valid = get_field("tunnel_ipv6.$valid$"),
      .version = get_field("tunnel_ipv6.version"),
      .dscp = get_field("tunnel_ipv6.dscp"),
      .ecn = get_field("tunnel_ipv6.ecn"),
      .flow_label = get_field("tunnel_ipv6.flow_label"),
      .payload_length = get_field("tunnel_ipv6.payload_length"),
      .next_header = get_field("tunnel_ipv6.next_header"),
      .hop_limit = get_field("tunnel_ipv6.hop_limit"),
      .src_addr = get_field("tunnel_ipv6.src_addr"),
      .dst_addr = get_field("tunnel_ipv6.dst_addr"),
  };
  auto tunnel_gre = SaiGre{
      .valid = get_field("tunnel_gre.$valid$"),
      .checksum_present = get_field("tunnel_gre.checksum_present"),
      .routing_present = get_field("tunnel_gre.routing_present"),
      .key_present = get_field("tunnel_gre.key_present"),
      .sequence_present = get_field("tunnel_gre.sequence_present"),
      .strict_source_route = get_field("tunnel_gre.strict_source_route"),
      .recursion_control = get_field("tunnel_gre.recursion_control"),
      .acknowledgement_present =
          get_field("tunnel_gre.acknowledgement_present"),
      .flags = get_field("tunnel_gre.flags"),
      .version = get_field("tunnel_gre.version"),
      .protocol = get_field("tunnel_gre.protocol"),
  };
  auto ipv4 = SaiIpv4{
